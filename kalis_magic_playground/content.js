const CONTENT = {
  reviews: [
    ...
    { quote: "인생에 없을 사람들이 많은 곳에 홀로 선 일이였는데 너무 즐거운 추억과 경험을 남길 수 있었어요ㅎㅎ 정말로 후회 없는 즐거운 하루가 되어 이 기억을 힘들 때 떠올릴 수 있을 것 같아요!", label: "혼자 참가한 M님" },
    { quote: "가까이서 공연을 보면서 계속 신기한 현상들을 보여주셔서 1시간 조금 넘은 공연이였는데 너무 짧게 느껴질 정도로 재미있었습니다!", label: "대번개 참가자 S님" },
  ],
  visitorCards: [
