const CONTENT = {
  reviews: [
    ...
    { quote: "마술을 좋아한다면 한 번은 와봐야 할 모임", label: "대번개 참가자 P님" },
    { quote: "마술인이면 절대 후회 안하는 모임", label: "대번개 참가자 K님" },
    { quote: "처음와도 다같이 어울리수있는, 소외되는 사람이 단한명도 없슴", label: "대번개 참가자 L님" },
    { quote: "인생에 없을 사람들이 많은 곳에 홀로 선 일이였는데 너무 즐거운 추억과 경험을 남길 수 있었어요ㅎㅎ<br>정말로 후회 없는 즐거운 하루가 되어 이 기억을 힘들 때 떠올릴 수 있을 것 같아요!", label: "혼자 참가한 M님" },
    { quote: "가까이서 공연을 보면서 계속 신기한 현상들을 보여주셔서<br>1시간 조금 넘은 공연이였는데 너무 짧게 느껴질 정도로 재미있었습니다!", label: "대번개 참가자 S님" },
  ],
  visitorCards: [
