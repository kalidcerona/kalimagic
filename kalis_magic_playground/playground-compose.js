(function () {
  const PLAYGROUND_GUIDES = {
    ...
    magazine: {
      label: '보관된 기록',
      description: '마술문화 기록소에 쌓인 좋은 질문과 답변, 후기와 리뷰를 골라 오래 볼 수 있게 모아두는 공간임.',
      userGuide: '이곳은 마술문화 기록소에서 오래 남기고 싶은 글을 모아두는 공간임. 좋은 질문, 좋은 답변, 좋은 후기, 좋은 리뷰가 매거진 후보가 될 수 있음.',
      titleExamples: [
